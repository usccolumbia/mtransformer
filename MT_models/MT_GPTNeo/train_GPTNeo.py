#python train_GPTNeo.py  --tokenizer ./tokenizer/   --train_data  ../MT_Dataset/hy_mix/train.txt  --valid_data ../MT_Dataset/hy_mix/valid.txt  --output_dir ./output
...
parser.add_argument('--h_size', type=int, default=180,
...
parser.add_argument('--attention_type', type=int, default=6, 
                        help='attention type')  
...
config = GPTNeoConfig(
    ...
    attention_types = [[['global', 'local'], args.attention_type]],
